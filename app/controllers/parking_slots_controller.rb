  ...
  def create
    ...
    respond_to do |format|
      if @parking_slot.save
        format.html { redirect_to parking_slots_url, notice: "Parking slot was successfully created." }
  ...
  def update
    respond_to do |format|
      if @parking_slot.update(parking_slot_params)
        format.html { redirect_to parking_slots_url, notice: "Parking slot was successfully updated." }
