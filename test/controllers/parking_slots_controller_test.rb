...
class ParkingSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking_slot" do
    assert_difference("ParkingSlot.count") do
      post parking_slots_url, params: { parking_slot: { slotNumber: @parking_slot.slotNumber, status: @parking_slot.status } }
    end
  ...
  test "should update parking_slot" do
    patch parking_slot_url(@parking_slot), params: { parking_slot: { slotNumber: @parking_slot.slotNumber, status: @parking_slot.status } }
