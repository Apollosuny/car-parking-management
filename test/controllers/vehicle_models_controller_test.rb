...
class VehicleModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_model" do
    assert_difference("VehicleModel.count") do
      post vehicle_models_url, params: { vehicle_model: { bodyType: @vehicle_model.bodyType, brand: @vehicle_model.brand, color: @vehicle_model.color, model: @vehicle_model.model, year: @vehicle_model.year } }
    end
  ...
  test "should update vehicle_model" do
    patch vehicle_model_url(@vehicle_model), params: { vehicle_model: { bodyType: @vehicle_model.bodyType, brand: @vehicle_model.brand, color: @vehicle_model.color, model: @vehicle_model.model, year: @vehicle_model.year } }
